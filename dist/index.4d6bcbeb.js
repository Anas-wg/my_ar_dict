...
class TheHeader extends (0, _coreComponent.CoreCompoent) {
    ...
    <h1>Al-Klimat</h1>
        <ul>
          <!-- State\u{C758} menu \u{BC30}\u{C5F4}\u{C744} map \u{BA54}\u{C11C}\u{B4DC}\u{B97C} \u{C774}\u{C6A9}\u{D558}\u{C5EC} \u{CF5C}\u{BC31}\u{D568}\u{C218}\u{B97C} \u{D638}\u{CD9C} -->
          <!-- \u{CF5C}\u{BC31}\u{D568}\u{C218}\u{B294} \u{BC30}\u{C5F4}\u{B0B4} href \u{C18D}\u{C131}\u{ACFC} location \u{AC1D}\u{CCB4}\u{C758} hash \u{AC12}\u{C744} \u{BE44}\u{AD50} -->
...
},{"./Home":"0JSNG","./About":"gdB30","./Noun":"a4xRt","./Verb":"KYWK6","../core/coreComponent":"2sEqF","./Serach":"km0km","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"0JSNG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _coreComponent = require("../core/coreComponent");
...
},{"../core/coreComponent":"2sEqF","../components/WordList":"baYYT","./Serach":"km0km","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"baYYT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class WordList extends (0, _coreComponent.CoreCompoent) {
    ...
    async fetchData() {
        try {
            ...
            const response = await (0, _axiosDefault.default).get("https://768953f5-0085-487e-901f-194a33fe695d.mock.pstmn.io/wordlist");
    ...
    render() {
        ...
        this.el.innerHTML = /* html */ `
      <ul>
        ${currentPageData.map(function(element) {
            return `
    ...
    `;
        ...
        inputEls.forEach((element)=>{
            element.addEventListener("change", (event)=>{
                ...
                if (event.target.checked) listItem.classList.add("checked");
...
},{"axios":"jo6P5","../core/coreComponent":"2sEqF","../worddata":"ctuUF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ctuUF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Search extends (0, _coreComponent.CoreCompoent) {
    ...
    <input
      ...
      <div>
        <ul>
          <li class="result">\u{B2E8}\u{C5B4}\u{B97C} \u{AC80}\u{C0C9}\u{D574} \u{BCF4}\u{C138}\u{C694}!</li>
        </ul>
      </div>
...
},{"../core/coreComponent":"2sEqF","../worddata":"ctuUF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["anvqh","gLLPy"], "gLLPy", "parcelRequiref982")
